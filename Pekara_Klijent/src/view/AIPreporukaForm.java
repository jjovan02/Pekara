...
public class AIPreporukaForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblNaslov.setText("AI Preporuka količina peciva");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(17, 17, 17)
                        .addComponent(lblNaslov, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(18, 18, 18)
    ...
    private void btnPreporuciActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPreporuciActionPerformed
        ...
        lblStatus.setText("Čekam odgovor od AI servisa...");
        taRezultat.setText("");

        new Thread(() -> {
            try {
                Properties props = new Properties();
                props.load(new FileInputStream("config/openai.properties"));
                ...
                String rezultat = service.getPreporuka(request);

                SwingUtilities.invokeLater(() -> {
                    taRezultat.setText(rezultat);
                    lblStatus.setText("Gotovo! (" + imenaPeciva.size() + " peciva poslato AI-u)");
                    btnPreporuci.setEnabled(true);
                });

            } catch (Exception ex) {
                SwingUtilities.invokeLater(() -> {
                    taRezultat.setText("Greška: " + ex.getMessage());
                    lblStatus.setText("Greška pri komunikaciji sa AI servisom.");
                    btnPreporuci.setEnabled(true);
                });
            }
        }).start();
