...
public class VratiListuSviKupacTest extends TestBase {

    private VratiListuSviKupac soVrati;

    @Before
    public void setUp() {
        soVrati = new VratiListuSviKupac();
    }
    ...
    public void testPreconditionPogresanTip() {
        try {
            soVrati.precondition("nije kupac");
    ...
    public void testVratiListuUspesno() {
        ...
        try {
            ArrayList<Kupac> lista =
                    (ArrayList<Kupac>) soVrati.execute(k);
