...
public class PekaraAIServiceImpl implements PekaraAIService {
    ...
    public String getPreporuka(PekaraAIRequest request) {
        ...
        // Ispravljeno: GPT_4_O_MINI (veliko slovo O) umesto GPT_4_1_MINI
        ...
        return client.chat().completions().create(params)
                ...
                .orElse("Nije dobijen odgovor od AI servisa.");
    }
    ...
    private String kreirajPrompt(PekaraAIRequest request) {
        return """
                ...
                """.formatted(request.getTipDogadjaja(), request.getBrojGostiju(), String.join(", ", request.getImenaPeciva()));
    }
}